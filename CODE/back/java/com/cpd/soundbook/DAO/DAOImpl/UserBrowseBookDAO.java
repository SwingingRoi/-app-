...
public class UserBrowseBookDAO implements com.cpd.soundbook.DAO.DAOInterface.UserBrowseBookDAO {
    ...
    public List<UserBrowseBook> searchRecords(String account, int day, int from, int size) {
        ...
        try{
            ...
            if(day == 0){
                hql = "from com.cpd.soundbook.Entity.UserBrowseBook  where account=:account and time>=:start and time<=:till";
                ...
                hql = "from com.cpd.soundbook.Entity.UserBrowseBook  where account=:account and time<=:till";
                query = session.createQuery(hql);
                query.setParameter("account",account);
